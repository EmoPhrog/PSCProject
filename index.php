  ...
  <section class="hero" id="hero-section">
    <div class="container">
      <div class="hero-content">
        ...
        <form id="searchForm" class="hero-form">
          <div class="input-wrapper">
            <label for="carModel" class="input-label">Car, model, or brand</label>
            <input type="text" name="car-model" id="carModel" class="input-field" placeholder="What car are you looking?">
          </div>
          <div class="input-wrapper">
            <label for="maxPayment" class="input-label">Max. monthly payment</label>
            <input type="number" name="monthly-pay" id="maxPayment" class="input-field" placeholder="Add an amount in RM">
          </div>
          <div class="input-wrapper">
            <label for="makeYear" class="input-label">Make Year</label>
            <input type="number" name="year" id="makeYear" class="input-field" placeholder="Add a minimal make year">
          </div>
