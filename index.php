  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <div class="header-actions">
        <a href="/localhost/function_page/login.php" class="btn user-btn">Login</a>
        <a href="/localhost/function_page/register.php" class="btn">Sign Up</a>
  ...
  <section class="hero" id="hero-section">
    <div class="container">
      <div class="hero-content">
        ...
        <p class="hero-text">
          From luxury cars to adventure gear, we've got everything you need for an <br>
          unforgettable experience. Flexible plans starting at just $199/month.
        </p>
        ...
        <div class="featured-car-card">
          ...
          <div class="card-content">
            ...
            <div class="card-price-wrapper">
              <p><strong>$439</strong> / month</p>
              <a href="http://localhost/function_page/payment.php" class="btn">Rent Now</a>
            </div>
          </div>
        </div>
      </li>
        ...
        <ul class="get-start-list">
          <li>
            <div class="get-start-card">
              <div class="card-icon icon-1">
                <img src="./assets/images/customer_pic.jpg" alt="customer">
              </div>
              <h3 class="card-title">Alvin Chin</h3>
              <p class="card-text">
          ...
          <li>
            <div class="get-start-card">
              ...
              <h3 class="card-title">Sarah Jim</h3>
              <p class="card-text">
          ...
          <li>
            <div class="get-start-card">
              ...
              <h3 class="card-title">Nicholas Lim</h3>
              <p class="card-text">
          ...
          <li>
            <div class="get-start-card">
              ...
              <h3 class="card-title">Jamal Ong</h3>
              <p class="card-text">
    ...
    <div class="container">
      ...
      <div class="footer-bottom">
        <ul class="social-list">
          <li><a href="https://www.facebook.com/friends/suggestions/?profile_id=61573716431847" class="social-link"><i class="fab fa-facebook"></i></a></li>
          <li><a href="#" class="social-link"><i class="fab fa-twitter"></i></a></li>
          <li><a href="#" class="social-link"><i class="fab fa-instagram"></i></a></li>
        </ul>
        <p class="copyright">&copy; 2025 Ridex. All rights reserved.</p>
      </div>
    </div>
  </footer>
