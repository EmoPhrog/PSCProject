...
// Database connection (adjust these to your actual DB credentials)
$host = "localhost";
$user = "root";
$pass = "";
$db   = "user";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Prepare statement to get user data by username
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <div class="header-actions">
        <a href="login.php" class="btn user-btn active">Login</a>
    ...
    <section class="section auth-section">
      <div class="container">
        <div class="auth-card">
          ...
          <p class="section-text">Welcome back! Please login to your account</p>
          ...
          <p class="auth-footer">
            Don't have an account? <a href="/car_rental/assets/php/register.php">Sign up</a>
          </p>
        </div>
      </div>
    </section>
